      ...
      <TransitionGroup tag="div" name="list"
        ...
        <div v-for="licencie in filteredLicencies" :key="licencie.id || licencie.licence"
          ...
          <div class="relative mb-5">
            <img v-if="licencie.photo" :src="licencie.photo" class="w-28 h-28 rounded-full object-cover ring-4 ring-blue-300 ring-offset-2" loading="lazy" width="112" height="112">
