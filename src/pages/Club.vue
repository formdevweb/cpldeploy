<template>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        <div v-for="(member, index) in team" :key="member.name"
          ...
          <div :class="[member.isInvitation ? 'bg-yellow-400' : 'bg-brand-accent', 'h-24 flex items-center justify-center']">
            <svg v-show="!member.isInvitation" class="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
          </div>
          <div class="p-6">
  ...
  <section class="py-16 md:py-32 bg-gray-200 text-gray-800">
    <div class="container mx-auto px-4 lg:px-12 text-center">
      <h2 class="text-4xl sm:text-5xl lg:text-6xl font-bold mb-2 tracking-tight text-brand-primary">Lieu et Accès</h2>
              <p class="text-xl font-medium mb-24 max-w-3xl mx-auto text-gray-700">
                Retrouvez-nous facilement dans notre salle moderne au cœur de Libercourt
              </p>      <div class="flex flex-wrap justify-center gap-8">
        
        <div class="bg-white/50 p-6 rounded-lg shadow-md w-full md:w-2/5 transition hover:-translate-y-1 hover:shadow-xl backdrop-blur-sm border border-gray-300 flex flex-col">
          <h3 class="text-2xl font-bold text-brand-accent mb-6 tracking-tight inline-block px-4 py-2 bg-green-100 border-b-2 border-brand-accent mx-auto">Informations d'accès</h3>
          <div class="text-left space-y-6 flex-grow">
            <div class="flex items-start">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-brand-accent mr-4 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
              <div>
                <span class="font-semibold block mb-1">Adresse</span>
                <p class="text-gray-800">Salle Deladerriere - Complexe Sportif Leo Lagrange</p>
                <p class="text-gray-800">Complexe Sportif Léo Lagrange</p>
                <p class="text-gray-800">62820 Libercourt</p>
              </div>
            </div>
            <div class="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-brand-accent mr-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 014 0z" /></svg>
              <span class="font-semibold">Parking gratuit disponible</span>
            </div>
            <div class="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-brand-accent mr-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6m3 0V4a3 3 0 013-3h3a3 3 0 013 3v15m-6 0h6" /></svg>
              <span class="font-semibold">Accès PMR</span>
            </div>
          </div>
          <div class="mt-6 flex flex-col space-y-2">
            <a href="https://www.google.com/maps/search/?api=1&query=32+Rue+André+Pantigny,+62820+Libercourt" target="_blank" class="bg-brand-primary text-white py-3 px-4 rounded-lg text-center hover:bg-brand-accent transition-colors duration-300 font-semibold">Voir sur Google Maps</a>
            <a href="https://www.google.com/maps/dir/?api=1&destination=32+Rue+André+Pantigny,+62820+Libercourt" target="_blank" class="bg-gray-100 text-brand-primary py-3 px-4 rounded-lg text-center hover:bg-gray-200 transition-colors duration-300 font-semibold border border-gray-400">Calculer l'itinéraire</a>

          </div>
        </div>

        <div class="p-4 w-full md:w-2/5 overflow-hidden rounded-lg shadow-lg border border-gray-300">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d57436.30448115611!2d2.9558561042930567!3d50.49044296235237!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e6!4m0!4m5!1s0x47c2d29bb3e4eea3%3A0x3b6f435785d0518!2s32%20Rue%20Andr%C3%A9%20Pantigny%2C%2062820%20Libercourt!3m2!1d50.4821539!2d3.0175519!5e0!3m2!1sfr!2sfr!4v1758212759277!5m2!1sfr!2sfr"
            width="100%"
            height="450"
            style="border:0;"
            allowfullscreen=""
